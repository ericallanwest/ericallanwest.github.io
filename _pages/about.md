...
- Develop datasets, tools, dashboards, and visualizations that help stakeholders prioritize resurfacing projects to reduce wet weather, roadway departure, curve, intersection, and pedestrian-related crashes.
...
**Master of Science in Geography** - [Virginia Tech](https://geography.vt.edu/) (2020)
...
**Recognized Judge** - [Beer Judge Certification Program](https://www.bjcp.org/) (2013)
...
- Developed curriculum for summer enrichment courses on [Japanese logic puzzles](https://en.wikipedia.org/wiki/Nikoli_(publisher)#Nikoli_puzzles) and [video game design](https://gamestarmechanic.com/).
...
- Builds on past seasonal employment as Catawba Mountain Ridgerunner for the [Appalachian Trail Conservancy](https://appalachiantrail.org/our-work/conservation/education-and-outreach/about-the-appalachian-trail-ridgerunner-program/) in 2012 and 2015.

**Pickleball** (2024-Present)
- Active [intermediate-level](https://dashboard.dupr.com/dashboard/player/6886111230) player with multiple podium finishes in singles league play.

**Great Smoky Mountains 900 Miler Club** (2019-2022)
- Successful completion of all official hiking trails in the Smokies. (See my [smokies](https://ericallanwest.github.io/smokies/) repository for details.)

**Earthen Cottage Project** (2008-2019)
- Built and maintained an off-grid [cob](https://en.wikipedia.org/wiki/Cob_(material)) cottage using solar panels for electricity and a wood-burning stove for heat.

**European Long-Distance Trails** (2006)
- Self-supported backpacking trips on world-renowned hiking trails such as the Pennine Way (England), West Highland Way and Southern Upland Way (Scotland), GR20 (Corsica), and Tour du Mont Blanc (Switzerland, Italy, France).
